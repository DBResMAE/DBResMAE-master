...
for k in range(0, 10):
    ...
    load_ADNI_array = np.load('/home/manjianzhi/jinjin/MAE/Baseline_images/ADNI_test_fake_datas_'+str(k+1)+'.npy')
    load_HCP_array = np.load('/home/manjianzhi/jinjin/MAE/Baseline_images/HCP_test_fake_datas_'+str(k+1)+'.npy')
    load_NACC_array = np.load('/home/manjianzhi/jinjin/MAE/Baseline_images/NACC_test_fake_datas_'+str(k+1)+'.npy')
    load_OASIS_array = np.load('/home/manjianzhi/jinjin/MAE/Baseline_images/OASIS_test_fake_datas_'+str(k+1)+'.npy')

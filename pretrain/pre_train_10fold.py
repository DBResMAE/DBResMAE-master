...
for k in range(5,10):
    ...
    mae = ResModel_DBMAE.mae_vit_base_patch16_dec512d8b()
    mae = mae.cuda()
    ...
    torch.save(mae.state_dict(), './weights/pretrain_10fold_new/ResModel_DBMAE_wegihts_fold_'+str(k+1)+'.pth')

    print("第",str(k+1),"折ResModel-DBMAE模型训练完毕！模型权重已保存！")
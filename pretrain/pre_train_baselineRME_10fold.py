...
for k in range(0,10):
    ...
    mae = Baseline_RME.mae_vit_base_patch16_dec512d8b()
    mae = mae.cuda()
    ...
    torch.save(mae.state_dict(), './weights/RME_10fold/Baseline_RME_wegihts_fold_'+str(k+1)+'.pth')

    print("第",str(k+1),"折Baseline_RME模型训练完毕！模型权重已保存！")
    exit(0)
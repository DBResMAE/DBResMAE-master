...
for k in range(0,10):
    ...
    mae = Baseline.mae_vit_base_patch16_dec512d8b()
    mae = mae.cuda()
    ...
    for epoch in range(num_epochs):
        ...
        if early_stopping.early_stop:
            ...
            break  # 跳出迭代，结束训练\
    torch.save(mae.state_dict(), './weights/baseline_10fold/Baseline_wegihts_fold_'+str(k+1)+'.pth')

    print("第",str(k+1),"折Baseline模型训练完毕！模型权重已保存！")
...
sys.path.append('/home/lijinjin22/code/mae-main')
from vision_transformer3d import Block
from PatchEmbed3D_residual import PatchEmbed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=(112, 128, 112), patch_size=16, in_chans=1,
        ...
        self.blocks = nn.ModuleList([
            Block(embed_dim, num_heads, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer,num_patches=99,batch_size=1)
        ...
        self.decoder_blocks = nn.ModuleList([
            Block(decoder_embed_dim, decoder_num_heads, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer,num_patches=393,batch_size=1)
    ...
    def initialize_weights(self):
        ...
        decoder_pos_embed = get_2d_sincos_pos_embed(self.decoder_pos_embed.shape[-1], int(self.patch_embed.num_patches**.5), cls_token=True, flag=True)
    ...
    def forward_encoder(self, x, mask_ratio):
        ...
        x1, mask, ids_restore = self.random_masking(x1, mask_ratio)
    ...
    def forward_decoder(self, x, ids_restore):
        ...
        for blk in self.decoder_blocks:
            x = blk(x)
        x = self.decoder_norm(x) #1,393,512

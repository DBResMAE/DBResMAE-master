...
# from self_attention_find import SelfAttentionModule
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def x2_reshape(self, x2):
        ...
        result_tensor = torch.zeros(4, 7, 8, 7, 96 * 8, device=device)
    ...
    def forward_encoder(self, x, mask_ratio):
        ...
        x2 = x2.reshape(4, 14, 16, 14, 96)
        x2 = self.x2_reshape(x2)

        x2 = x2.reshape(4, 7 * 8 * 7, 768)

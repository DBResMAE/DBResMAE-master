...
for k in range(0, 10):
    ...
    # with open('/home/lijinjin22/ADNI_GM_1/ADNI_auto_train_test/pkl_val/ADNI_val'+str(k+1)+'.pkl', 'rb') as f:
    #     val_loader = pickle.load(f)

    with open('/home/lijinjin22/MAE/Baseline_RME_images/ADNI_test_fake_datas_'+str(k+1)+'.pkl', 'rb') as f:
    ...
    mae = model_vit_Baseline_RME.vit_base_patch16()
    ...
    # load model
    mae.load_state_dict(torch.load('./weights/RME_10fold/Baseline_RME_wegihts_fold_'+str(k+1)+'.pth'), strict=False)
    ...
    torch.save(mae.state_dict(), './weights/finetune_Baseline_RME/finetune_fold_'+str(k+1)+'.pth')
    ...
    # 生成混淆矩阵
    conf_mat = confusion_matrix(y_true, y_pred_eegnet)
    print(conf_mat)

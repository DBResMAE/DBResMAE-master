...
for k in range(0, 10):
    ...
    with open('/home/manjianzhi/jinjin/MAE/Baseline_images/ADNI_test_fake_datas_'+str(k+1)+'.pkl', 'rb') as f:
    ...
    mae = model_vit_Baseline.vit_base_patch16()
    ...
    # load model
    mae.load_state_dict(torch.load('./weights/baseline_10fold/Baseline_wegihts_fold_'+str(k+1)+'.pth'), strict=False)
    ...
    torch.save(mae.state_dict(), './weights/finetune_Baseline/finetune_fold_'+str(k+1)+'.pth')

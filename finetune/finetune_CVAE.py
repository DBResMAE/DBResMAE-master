...
for k in range(0, 1):
    ...
    with open('/home/lijinjin22/MAE/CVAE_images/ADNI_test_fake_datas_'+str(k+1)+'.pkl', 'rb') as f:
    ...
    # load model
    mae.load_state_dict(torch.load('./weights/finetune_Baseline_RME/finetune_fold_'+str(k+1)+'.pth'), strict=False)

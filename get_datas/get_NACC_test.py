...
path = '/home/manjianzhi/jinjin/CSV_100/NACC_10fold'
path2 = "/home/manjianzhi/jinjin/NACC_T1_prosessed"
...
for k in range(0, 10):
    ...
    val_path = path + "/NACC_fold_"+str(k+1)+".csv"
    ...
    train_file = '/home/manjianzhi/jinjin/NACC_pkl/NACC_test'+str(k+1)+'.pkl'

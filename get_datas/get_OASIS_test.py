...
path = '/home/manjianzhi/jinjin/CSV_100/OASIS_10fold'
path2 = "/home/manjianzhi/jinjin/OASIS_T1_prosessed"
...
for k in range(0, 10):
    ...
    val_path = path + "/OASIS_fold_"+str(k+1)+".csv"
    ...
    train_file = '/home/manjianzhi/jinjin/OASIS_pkl/OASIS_test'+str(k+1)+'.pkl'

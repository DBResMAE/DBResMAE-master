...
from residual_block import ResNet, BasicBlock
...
class PatchEmbed(nn.Module):
    def __init__(self, img_size=(224, 224, 224), patch_size=16, embedding_dim=512):
        ...
        self.resnet = ResNet(BasicBlock, [1,64,128])
        self.bn = nn.BatchNorm3d(128)
        self.relu = nn.ReLU() #inplace=True
        self.conv_x = nn.Conv3d(128, self.embedding_dim, kernel_size=3, stride=2, padding=1)
